...
use App\Qris;
use App\User;
use App\Exports\QrisExport;
use Maatwebsite\Excel\Facades\Excel;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB; 

class Controller_AdminPerlindungan extends Controller
{
    public function openPage(){                             //buka halaman Manager - List Project
        ...
        return view('Pages.Admin.View_AdminPerlindungan', compact('userLevel', 'prod', 'mitra', 'pstat'));  
    }

    public function export(){
        $this->authorize('isAdmin', auth()->user());
        return (new QrisExport)->download('Data All QRIS.xlsx');
    }
