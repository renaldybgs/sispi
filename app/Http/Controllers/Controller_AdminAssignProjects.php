...
class Controller_AdminAssignProjects extends Controller
{
    public function openPage(){             //buka halaman Manager - Assign
        ...
        return view('Pages.Admin.View_AdminAssignProjects', compact('userLevel', 'users', 'products','mitras','ptypes'));
    }
    ...
    public function storeNew(Request $request){                         //tambah data projek baru
        ...
        $message = [
            ...
            'req_numb.required' => 'Mohon isi Registration Number',
                'req_numb.max' => 'Registration Number max 201 kata',
        ]);
        ...
        $newproject = Project::create([                                 //bikin data project baru    
            ...
            'req_numb' => $request->req_numb,
            // 'direktori_project' => $project_dir
        ]);

        return redirect('/admin/assign')->with('success','Project NSICCS berhasil di assign');
    }
