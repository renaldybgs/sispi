  ...
  <div class="card-body">
    <div class="tab-content" id="custom-tabs-three-tabContent">
      ...
      <div class="tab-pane fade active show" id="new" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
        <form method="post" action="/admin/newproject" id="my-form">
        @csrf
...
<!--           <div id="jenisp" class="form-group">
          ...
          <div id="reqnumb" class="form-group">
            <label for="req_numb">Registration Number</label>
            <input type="text" class="form-control  @error('req_numb') is-invalid @enderror" id="req_numb" placeholder="Registration Number" name="req_numb" autocomplete="off" value="{{ old('req_numb') }}" style="width: 100%;">
            @error('req_numb')
              <div class="invalid-feedback flash" style="margin-top: 2px">
                {{ $message }}</div>
            @enderror
