...
@push('styles')
@section('PageTitle', 'Sertifikasi QRIS Spesifikasi')
@section('content')
<title>
    ...
    <div class="row mt-2">
        <div class="col-md-12">
            ...
            <div class="card card-info card-outline">
                <div class="card-body">
                    <a href="/engineer/assignqrisspek" type="button" class="btn btn-success" title="Tambah QRIS Spesifikasi" id="btn-modal" style="float:left">
                    Tambah QRIS Spesifikasi &nbsp<i class="fas fa-plus"></i>
                    </a>
