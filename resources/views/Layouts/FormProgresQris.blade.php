{!! Form::model($qris, [
	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="form-group">
				<div class ="input-group-addon">
					<label for="ijin_qrisbi" style="font-weight:bolder" style="margin-top: -30px">Ijin BI</label>
						<br>
...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="form-group">
			<div class ="input-group-addon">
				<label for="surat_rekomendasi" style="font-weight:bolder" style="margin-top: -30px">Tanggal Rekomendasi</label>
					<br>
				{!! Form::date('surat_rekomendasi', null,
					['class'=> 'form-control',
						'id' =>'surat_rekomendasi',
						'placeholder' => 'Masukan Tanggal Rekomendasi',
						'style' =>'margin-bottom: 10px'
					])
				!!}		
			</div>
