@switch($data->id_pstat)
  @case(1)
    ...
    @break
  @case(2)
    <small class="badge bg-primary"><i class="fas fa-spinner"></i>&nbsp PIF-New</small>
    @break
  @case(3)
    <small class="badge bg-info"><i class="fas fa-check"></i>&nbsp PIF-Review</small>
    @break
  @case(4)
    <small class="badge bg-secondary"><i class="fa fa-list-ol"></i>&nbsp PIF-Numbering</small>
    @break
  @case(5)
  ...
  @case(8)
    ...
    @break
  @case(9)
    <small class="badge bg-navy"><i class="fas fa-history"></i>&nbsp CTF-Signed</small>
    @break
  @case(10)
  ...
  @case(17)
    ...
    @break
  @case(18)
    <small class="badge bg-warning"><i class="fas fa-ban"></i>&nbsp PIF-Failed</small>
    @break
  @case(19)
