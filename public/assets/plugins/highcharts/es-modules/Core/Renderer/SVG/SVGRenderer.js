...
// #15291
var rect = function (x, y, w, h) { return [
    ['M', x, y],
    ['L', x + w, y],
    ['L', x + w, y + h],
    ['L', x, y + h],
...
SVGRenderer.prototype.symbols = {
    ...
    arc: function (x, y, w, h, options) {
        var arc = [];
        if (options) {
            var start = options.start || 0, end = options.end || 0, rx = pick(options.r, w), ry = pick(options.r, h || w), proximity = 0.001, fullCircle = Math.abs(end - start - 2 * Math.PI) <
                proximity, 
